...
sort_byCounntry = dt.sort_values(by='Country') # Places Column in alphabetical
sort_byCounntryAscending = dt.sort_values(by='Country',ascending=False) # Descending Order
